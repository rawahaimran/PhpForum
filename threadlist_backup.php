                    ...
                    <div class="row mb-2 d-flex align-items-center justify-content-center p-5 ">
                        <div class="d-flex flex-fill">
                            ...
                            <div class="flex-grow-1 ms-3">
                                ...
                                <span class="text-center ">Posted by <strong class="text-success"><?php echo $thread_user . 'Random'; ?> </strong></span>
        ...
        ?>
            ...
            ?>
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    <strong> Congratz </strong> Your comment has been added Successfully.
